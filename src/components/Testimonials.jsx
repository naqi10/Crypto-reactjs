          ...
          <div className="wow fadeInUp relative z-10 mb-10 overflow-hidden rounded-[10px] bg-white px-6 py-8 sm:p-10 md:p-8 xl:p-10 dark:bg-[#131B4D]" data-wow-delay="0s">
            ...
            <div className="mb-8 flex items-center">
              <div className="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded-sm">
                <img alt="author" loading="lazy" width="80" height="80" decoding="async" data-nimg="1" className="h-full object-cover" src="src/assets/image-02 (1).webp" style={{ color: "transparent" }} />
              </div>
      ...
      <div className="w-full px-4 md:w-1/2">
        <div style={{ opacity: 1, transform: "none" }}>
          <div className="wow fadeInUp relative z-10 mb-10 overflow-hidden rounded-[10px] bg-white px-6 py-8 sm:p-10 md:p-8 xl:p-10 dark:bg-[#131B4D]" data-wow-delay="0s">
            ...
            <div className="mb-8 flex items-center">
              <div className="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded-sm">
                <img alt="author" loading="lazy" width="80" height="80" decoding="async" data-nimg="1" className="h-full object-cover" src="src/assets/image-03 (1).webp" style={{ color: "transparent" }} />
              </div>
              <div className="w-full">
                <h3 className="text-dark mb-1 text-lg font-semibold dark:text-white">Jason Keys</h3>
                <p className="text-body-color-2 text-sm font-medium dark:text-white">CEO &amp; Founder @ Dreampeet.</p>
     ...
     <div className="w-full px-4 md:w-1/2">
        <div style={{ opacity: 1, transform: "none" }}>
          <div className="wow fadeInUp relative z-10 mb-10 overflow-hidden rounded-[10px] bg-white px-6 py-8 sm:p-10 md:p-8 xl:p-10 dark:bg-[#131B4D]" data-wow-delay="0s">
            ...
            <div className="mb-8 flex items-center">
              <div className="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded-sm">
                <img alt="author" loading="lazy" width="80" height="80" decoding="async" data-nimg="1" className="h-full object-cover" src="src/assets/image-04 (1).webp" style={{ color: "transparent" }} />
              </div>
              <div className="w-full">
                <h3 className="text-dark mb-1 text-lg font-semibold dark:text-white">Jason Keys</h3>
                <p className="text-body-color-2 text-sm font-medium dark:text-white">CEO &amp; Founder @ Dreampeet.</p>
      ...
      <div className="w-full px-4 md:w-1/2">
        <div style={{ opacity: 1, transform: "none" }}>
          <div className="wow fadeInUp relative z-10 mb-10 overflow-hidden rounded-[10px] bg-white px-6 py-8 sm:p-10 md:p-8 xl:p-10 dark:bg-[#131B4D]" data-wow-delay="0s">
            ...
            <div className="mb-8 flex items-center">
              <div className="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded-sm">
                <img alt="author" loading="lazy" width="80" height="80" decoding="async" data-nimg="1" className="h-full object-cover" src="src/assets/image-01 (1).webp" style={{ color: "transparent" }} />
              </div>
              <div className="w-full">
                <h3 className="text-dark mb-1 text-lg font-semibold dark:text-white">Jason Keys</h3>
                <p className="text-body-color-2 text-sm font-medium dark:text-white">CEO &amp; Founder @ Dreampeet.</p>
